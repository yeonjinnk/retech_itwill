...
<body>
<header><jsp:include page="/WEB-INF/views/inc/top.jsp"></jsp:include></header>
				...
				<tr>
					<td class="td1" align="left" ><span
						...
						<input type="image" id="imgup" onclick="img_preview();"
								src="${ pageContext.request.contextPath }/resources/images/image_upload.png" width="150px" height="150px">
						</td>
						...
						<div id="img_zone">
							...
							<div id="img_preview1" >
								<input type="image" id="imgup_1" onclick="send_1();"
									src="" width="150px" height="150px">								<!-- 삭제버튼 -->
...
<!-- 					<td colspan="2"><hr></td> -->
				...
				<tr>
					...
					<td class="td2" align="left">
						...
						<input maxlength="40" value="${product.pd_subject}""
					...
					<td align="left">
						...
						<div>
							<textarea class="input-tag"
								...
								placeholder="구입연도, 브랜드, 사용감, 하자유무 등 필요한 정보를 넣어주세요. &#13;&#10;구매자의 문의를 좀더 줄일 수 있습니다.">${ product.pd_content }
							</textarea>
						</div>
<%-- 						<div align="right"><span style="font-size: 18px;"id="exp_length">${ fn:length(product.product_content) }/1000</span></div> --%>
					</td>
				</tr>
